      ...
      <section className="card">
        ...
        {sessionData.map((item, index) => (
          <div className="answer-card" key={index}>
            ...
            <p><b>Communication Clarity:</b> {item.audioMetrics.communicationClarityScore}/100</p>
            <p><b>Filler Words:</b> {item.audioMetrics.fillerCount}</p>
            <p><b>Pauses:</b> {item.audioMetrics.pauseCount || 0}</p>
            <p><b>Longest Pause:</b> {item.audioMetrics.longestPauseSeconds || 0}s</p>
            <p><b>Speaking Rate:</b> {item.audioMetrics.speakingRateWPM || 0} WPM</p>
            <p><b>Tone Estimate:</b> {item.audioMetrics.toneLabel || "steady"}</p>
            <p><b>Pitch Variation Estimate:</b> {item.audioMetrics.pitchVariation || 0}</p>
            ...
            <p><b>Stress Indicators:</b> {(item.videoMetrics.stressIndicators || []).join(", ") || "None"}</p>
